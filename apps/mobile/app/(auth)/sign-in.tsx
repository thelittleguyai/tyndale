    ...
    <View className="flex-1 items-center justify-center bg-navy-deep px-6">
      ...
      {sent ? (
        <View className="w-full max-w-xs items-center">
          ...
          <Pressable onPress={onEmail} disabled={cooldown > 0} className="mt-4">
            <Text
              className={cooldown > 0 ? 'text-xs text-white/40' : 'text-xs font-semibold text-sage'}
            >
          ...
          <Pressable
            ...
            className={
              busy || !email.trim()
                ...
                : 'mt-3 items-center rounded-md bg-sage px-6 py-3'
            }
          >
            <Text
              className={
